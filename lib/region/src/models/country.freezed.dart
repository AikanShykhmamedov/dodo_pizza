...
abstract class $CountryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String isoName, int code, int order});
}
...
class _$_Country implements _Country {
  ...
  @override
  String toString() {
    return 'Country(name: $name, isoName: $isoName, code: $code, order: $order)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, isoName, code, order);
