...
abstract class $RegionCopyWith<$Res> {
  ...
  @useResult
  $Res call({Country country, City city});
...
class _$_Region implements _Region {
  const _$_Region({required this.country, required this.city});
  ...
  @override
  String toString() {
    return 'Region(country: $country, city: $city)';
  }
...
abstract class _Region implements Region {
  const factory _Region(
      {required final Country country, required final City city}) = _$_Region;
