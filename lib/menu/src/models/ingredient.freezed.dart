...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, bool isRemovable});
}
...
class _$_Ingredient implements _Ingredient {
  const _$_Ingredient({required this.name, required this.isRemovable});
  ...
  @override
  String toString() {
    return 'Ingredient(name: $name, isRemovable: $isRemovable)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, name, isRemovable);
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      required final bool isRemovable}) = _$_Ingredient;
